...
Xuro ${VERSION} is a local-first desktop notes application for Windows, macOS, and Linux. Notes are stored as plain Markdown files in a user-selected folder. The desktop app is free to download and use, under a source-available license (not MIT) — the source is open to read and contribute to, but redistribution and commercial use require permission. Xuro Cloud is an optional paid service for publishing linked notes and hosted images.

## Canonical pages

- [Home](${SITE_URL}/): Product overview and features
- [Download](${SITE_URL}/download): Windows installer (NSIS)
...
- Publishing: optional Xuro Cloud subscription; local editing does not require an account
