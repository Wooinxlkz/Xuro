...
export const alt = "Xuro: local-first Markdown notes for Windows, macOS, and Linux";
    ...
    (
      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 24 }}>
          ...
          >
            Local-first Markdown for Windows, macOS, and Linux — plain files you own.
          </div>
        </div>
        ...
        >
          <div style={{ display: "flex" }}>usexuro.app</div>
