...
export const metadata: Metadata = {
  ...
  description:
    "Practical guides to local-first notes, plain-text Markdown, Xuro on Windows, and working with an existing vault.",
  alternates: { canonical: "/guides" },
  openGraph: {
    title: "Markdown notes guides | Xuro",
    description:
...
const JSON_LD = {
  ...
  "@type": "CollectionPage",
  name: "Xuro Markdown notes guides",
