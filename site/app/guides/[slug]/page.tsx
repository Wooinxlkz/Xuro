    ...
    "@graph": [
      {
        ...
        author: { "@type": "Organization", name: "Xuro", url: absoluteUrl() },
      ...
      <main className="px-5 pb-20 pt-32 sm:px-8 sm:pt-40">
        ...
        <article className="mx-auto w-full max-w-3xl">
          ...
          <section className="mt-14 rounded-2xl border border-border p-6 sm:flex sm:items-center sm:justify-between sm:gap-8">
            <div>
              <h2 className="font-serif text-[26px] text-foreground">Try Xuro with your files.</h2>
              <p className="mt-2 text-[13.5px] leading-6 text-muted-foreground">
                Free to use, source-available, and built around portable Markdown.
              </p>
            </div>
            <div className="mt-5 flex flex-wrap gap-2 sm:mt-0 sm:shrink-0">
              <ButtonLink href="/download" size="sm">Download Xuro</ButtonLink>
