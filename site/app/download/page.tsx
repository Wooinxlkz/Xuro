...
import { LinuxIcon, WindowsIcon } from "@/components/download/PlatformIcons";
import { AnalyticsEvent } from "@/components/analytics/AnalyticsEvent";
import { DMG, LINUX_APPIMAGE, LINUX_DEB, VERSION, WINDOWS_EXE } from "@/lib/config";

export const metadata: Metadata = {
  title: "Download Xuro",
  description:
    "Download Xuro for Windows, Apple Silicon Macs, or x86_64 GNU/Linux systems.",
  alternates: {
    canonical: "/download",
  },
  openGraph: {
    title: "Download Xuro",
    description:
      "Download the Windows installer, the signed macOS app, or an x86_64 Linux AppImage or Debian package.",
    url: "/download",
  },
};
  ...
  return (
    <>
      ...
      <main className="px-5 pb-14 pt-24 sm:px-8 sm:pt-28">
        ...
        <section
          aria-label="Available Xuro downloads"
          className="mx-auto mt-8 grid w-full max-w-5xl gap-4 md:grid-cols-3 sm:mt-10"
        >
          <PlatformCard
            index="01"
            icon={<WindowsIcon className="size-[18px]" />}
            platform="Windows"
            architecture="x86_64"
            description="A standard installer for Windows 10 and 11. Run it, and Xuro installs and checks for updates automatically."
            details={[
              "Windows 10 or newer",
              "NSIS installer",
          ...
          <PlatformCard
            ...
            description="A native disk image for modern Macs. Open it, move Xuro to Applications, and start writing."
            details={[
              "macOS 12 or newer",
        ...
        <p className="mx-auto mt-4 max-w-5xl text-center font-mono text-[10.5px] tracking-[0.08em] text-faint">
          Source-available · No account · Your notes stay on your disk
        </p>
      </main>
      <Footer />
    </>
