...
export const metadata: Metadata = {
  title: "Changelog",
  description:
    "See what is new in Xuro, the local-first Markdown notes app for Windows, macOS, and Linux.",
  alternates: {
    canonical: "/changelog",
  },
  openGraph: {
    title: "Xuro changelog",
    description: "New features, refinements, and fixes in every Xuro release.",
    url: "/changelog",
  },
};
