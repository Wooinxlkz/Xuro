...
export const metadata: Metadata = {
  title: "Welcome to Xuro Cloud",
  description: "Your Xuro Cloud payment was completed successfully.",
        ...
        <section className="mx-auto w-full max-w-lg text-center">
          ...
          <p className="mx-auto mt-4 max-w-md text-pretty text-[14px] leading-6 text-muted-foreground">
            {failed
              ...
              : "Your Xuro Cloud subscription is being activated. Return to Xuro and your account will refresh automatically."}
          </p>
