...
const TODO_TAGS = ["work", "personal", "xuro"];
const TODOS = [
  { done: false, text: "Reply to design feedback", tag: "work" },
  { done: false, text: "Book flights for the offsite", tag: "personal" },
  { done: true, text: "Ship v0.1.1 to the updater", tag: "xuro" },
  { done: false, text: "Draft the Q3 roadmap", tag: "xuro" },
  { done: false, text: "Review agent ACP notes", tag: "xuro" },
];
