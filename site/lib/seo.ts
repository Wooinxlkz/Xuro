...
export const SITE_URL = "https://usexuro.app";
export const SITE_NAME = "Xuro";
export const SITE_TITLE = "Xuro: local-first Markdown notes for Windows, macOS, and Linux";
export const SITE_DESCRIPTION =
  "A fast, local-first Markdown notes app for Windows, macOS, and Linux. Keep plain .md files in folders you own, with rich editing, backlinks, search, and optional publishing.";
...
export const PRODUCT_JSON_LD = {
  ...
  "@graph": [
    ...
    },
    {
      ...
      operatingSystem: "Windows 10 or newer, x86_64",
