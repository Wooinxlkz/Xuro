...
export const LINUX_DEB = `${GITHUB}/releases/download/v${VERSION}/Xuro_${VERSION}_amd64.deb`;
export const WINDOWS_EXE = `${GITHUB}/releases/download/v${VERSION}/Xuro_${VERSION}_x64-setup.exe`;
