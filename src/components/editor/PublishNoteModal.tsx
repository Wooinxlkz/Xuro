        ...
        {loading ? (
          ...
          <div className="py-2 text-center">
            ...
            <p className="mx-auto mt-1.5 max-w-[330px] text-[11.5px] leading-5 text-muted">
              Sign in to publish this note and its linked pages with Xuro Cloud.
            </p>
            <p className="mt-2 text-[10.5px] text-faint">
              Publishing requires Xuro Cloud.
            </p>
            {error && (
          ...
          <div className="py-2 text-center">
            ...
            <p className="mx-auto mt-1.5 max-w-[330px] text-[11.5px] leading-5 text-muted">
              Public sites, linked pages, and image hosting are included with Xuro Cloud.
            </p>
            <div className="mt-5 flex justify-center gap-2 border-t border-line-soft pt-4">
...
function notifyPublishStatus(rel: string, published: boolean) {
  window.dispatchEvent(
    new CustomEvent("xuro:publish-status", {
