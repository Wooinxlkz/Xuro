  ...
  const actions = useMemo<PaletteItem[]>(() => {
    ...
    return [
      ...
      },
      {
        ...
        hint: formatShortcutText(shortcuts.openDailyNotes, mac),
        icon: CalendarDays,
        run: () => vault.setView({ type: "daily" }),
      },
      {
        id: "tags",
        label: "Open Tags",
        hint: formatShortcutText(shortcuts.openTags, mac),
        icon: Hash,
        run: () => vault.setView({ type: "tags" }),
      },
      {
        id: "kanban",
        label: "Open Kanban",
      ...
      },
      {
        ...
        icon: LayoutTemplate,
        run: () => vault.setView({ type: "templates" }),
      },
      {
        id: "graph",
        label: "Open Graph",
      ...
      },
      {
        ...
        icon: Minimize2,
        run: () => useUi.getState().toggleZenMode(),
      },
      {
        id: "settings",
        label: "Settings",
